"""Track external log sources for idempotent ingestion."""
...
def upgrade() -> None:
    with op.batch_alter_table("logs") as batch_op:
        ...
        batch_op.create_unique_constraint(
            "uq_logs_source_event", ["source", "source_event_id"]
        )


def downgrade() -> None:
    with op.batch_alter_table("logs") as batch_op:
        batch_op.drop_constraint("uq_logs_source_event", type_="unique")
